...
export const en = {
  ...
  "context.topic": "Topic",
  "citedBy.title": "How others cite it",
  "citedBy.hint":
    "Sentences from the papers that cite this one, where Semantic Scholar found the citation. Only sentences that name this paper by author or title are shown first.",
  "citedBy.loading": "Looking for the sentences...",
  "citedBy.error": "The sentences could not be loaded.",
  "citedBy.none": "Semantic Scholar has no citing sentences for this paper.",
  "citedBy.noNamed": "No sentence names this paper by author or title.",
  "citedBy.summary": "Sentences found in {n} of {total} citing papers.",
  "citedBy.influential": "Influential",
  "citedBy.influential.hint":
    "Semantic Scholar flags this citation as influential",
  "citedBy.onlyInfluential": "Influential only",
  "citedBy.more": "Show {n} more",
  "citedBy.others": "Show {n} that do not name the paper",
  "citedBy.others.hide": "Hide those",
  "citedBy.others.note":
    "Semantic Scholar linked these sentences to the paper, but they mention neither its authors nor its title, so they may be about a neighboring reference.",
  "citedBy.source":
    "Sentences are extracted automatically from the full text of the citing papers and can contain errors.",
  back: "← Back",
  ...
  "filters.year.to": "To",
  "filters.last5": "Last 5 years",
  "filters.last10": "Last 10 years",
  "filters.minCitations": "Min. citations",
  "filters.minCitations.any": "Any",
  "filters.minCitations.n": "{n}+",
  "filters.noYear":
    "Papers without a year are left out while a year is set, because we cannot tell where they fall.",
